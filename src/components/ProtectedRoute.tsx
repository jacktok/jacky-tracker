            ...
            <div className="space-y-4">
              {authConfig.googleLogin && (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-border rounded-lg hover:bg-accent hover:text-white transition-colors"
                >
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-text-secondary">
                  Authentication providers are not configured. Please contact your administrator.
                </p>
              </div>
            </div>
          )}
